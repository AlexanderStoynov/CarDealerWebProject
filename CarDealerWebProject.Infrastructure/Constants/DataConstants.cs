namespace CarDealerWebProject.Infrastructure.Constants
{
    public static class DataConstants
    {
        ...
        public const int VehicleMilageMax = 100000000;
        public const int VehicleMilageMin = 0;
        public const int VehicleMotorHorsePowerMax = 10000;
        public const int VehicleMotorHorsePowerMin = 1;
        ...
        public const int PetrolVehicleEngineCapacityMax = 100000;
        public const int PetrolVehicleEngineCapacityMin = 1;

        public const int ElectricCarBatteryCapacityMax = 1000;
        public const int ElectricCarBatteryCapacityMin = 1;
